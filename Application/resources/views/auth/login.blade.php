    ...
    <div class="container" id="container">
        <div class="form-container sign-up-container">
            <form method="POST" action="{{ route('register') }}">
                ...
                <span>Доступ будет предоставлен после модерации.</span>
                <input id="name" type="text" class="form-control @error('name') is-invalid
                @enderror" name="name" value="{{ old('name') }}"
                       required autocomplete="name" autofocus placeholder="ФИО">
                ...
                @enderror
                        ...
                        <input id="password-confirm" type="password" class="form-control" name="password_confirmation"
                               required autocomplete="new-password" placeholder="Повторить пароль">
        ...
        <div class="form-container sign-in-container">
            <form method="POST" action="{{ route('login') }}">
                ...
                <span>Воспользуйтесь своей учетной записью</span>
                <input id="email" type="email" class="form-control @error('email') is-invalid
                @enderror" name="email" value="{{ old('email') }}"
                ...
                @enderror
                <input id="password" type="password" class="form-control @error('password') is-invalid
                @enderror" name="password" required autocomplete="current-password" placeholder="Пароль">
        ...
        <div class="overlay-container">
            <div class="overlay">
                ...
                <div class="overlay-panel overlay-right">
                    <h1>Привет, еще нет аккаунта ?</h1>
                    <p>Подайте заявку на создание аккаунта, чтобы получить доступ к системе.</p>
                    <button class="ghost" id="signUp">Начать</button>
                </div>
            </div>
        </div>
    </div>
